...
function App() {
  useEffect(() => {
    const handleGlobalClick = (e) => {
      ...
      if (button) {
        const buttonText = button.innerText?.trim() || button.getAttribute('aria-label') || button.id || button.className || 'Unknown Button/Link';
        const currentCounts = JSON.parse(localStorage.getItem('buttonClicks') || '{}');
